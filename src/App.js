  ...
  useEffect(() => {
    setFirebaseData({
      Bio: {
        ...
        resume:
          "https://app.enhancv.com/share/56d521b5/?utm_medium=growth&utm_campaign=share-resume&utm_source=dynamic",
        linkedin: "https://www.linkedin.com/in/gustavo-pacheco28/",
        github: "https://github.com/creative2113/",
        description:
          "Senior Full Stack Developer with expertise in robust web applications and AI solutions. " +
        ...
        },
        {
          ...
          skills: [
            { name: "Django", image: "/icons/django-svg.svg" },
            {
              name: "Flask",
              image:
                "https://repository-images.githubusercontent.com/596892/cc2c69ec-9251-4b33-8283-b86a8659c9cb",
            },
      ...
      experiences: [
        ...
        // }
        {
          ...
          desc:
            "Actively engaged in developing innovative AI services, " +
            "including a healthcare chatbot and LLM-powered microservices, " +
            "with a focus on enhancing data management and user satisfaction through cloud platforms.",
        ...
        },
        {
          ...
          desc:
            "Contributed to Architect and develop multiple web applications, " +
            "including an ERP system and a scalable e-commerce platform utilzing innovative AI strategies, " +
            "while establishing CI/CD pipelines with Docker and Kubernetes, resulting in reduced project deployment time, and enhanced productivity and quality of code.",
        ...
        },
        {
          ...
          desc:
            "Enhanced data accuracy, processing speed, and revenue growth by spearheading innovative data solutions, " +
      ...
      projects: [
        {
          ...
          description:
            "Gavani is a platform for selling clothes online. " +
        ...
        },
        {
          ...
          description:
            "Leveraged full stack development in our ERP system to automate data entry, optimize supply chain management, and forecast inventory needs through predictive analytics. " +
        ...
        },
        {
          ...
          description:
            "Crafted an innovative AI-powered assistant chatbot for Fahertybrand, an American clothing sales e-commerce platform, " +
        ...
        },
        {
          ...
          description:
            "Innovative AI Assistant system be able to medical consultant with patient based on rich expert medical knowledge. " +
        ...
        },
        {
          ...
          description:
            "Developed and launched a cutting-edge AI Art Service platform utilizing the Stable Diffusion model and GANs, " +
        ...
        },
        {
          ...
          description:
            "A virtual voice assistant that can help you with a variety of tasks. " +
        ...
        },
        {
          ...
          title: "YATMATCH",
          description:
            "Yatmatch is a platform which brings yachts and people together. " +
        ...
        },
        {
          ...
          description:
            "AI-driven workflow designed for the insurance industry, focusing on the drafting, reviewing, and sending of complex insurance notices. " +
        ...
        },
        {
          ...
          title: "ChatSoc",
          description:
            "Developed 'ChatSoC,' an advanced chatbot using OpenAI's API in Python, " +
      ...
      education: [
        {
          ...
          grade: "3.6/4.0",
          desc:
            "In this course, I focused on developing an AI web service platform using " +
        ...
        },
        {
          ...
          grade: "3.7/4.0",
          desc:
            "I gained in-depth knowledge of programming languages like C++, Python, PHP, C#, Java and JavaScript, " +
          ...
          <Body>
            <Routes>
              ...
              <Route
                ...
                element={<TermsandConditions firebaseData={firebaseData} />}
              />
              <Route
                path="*"
                element={
